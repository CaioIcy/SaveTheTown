...
player = new Player(AMPLITUDE_X, AMPLITUDE_Y, CIRCLE_SPEED, MOVEMENT_START_POSITION, PLAYER_STARTING_X, PLAYER_STARTING_Y,10, playerSprite);
enemy = new Enemy(ENEMY_STARTING_X,ENEMY_STARTING_Y,15,ENEMY_SPEED);
